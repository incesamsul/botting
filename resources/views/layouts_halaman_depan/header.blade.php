                ...
                <div class="row">
                    <div class="col-6 text-left">
                        <ul class="top-links contact-info">
                            ...
                            <li><i class="fa fa-whatsapp"></i> {{ auth()->user()->email }}</li>
                        </ul>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-12 col-sm-6">
                        <a class="navbar-brand mr-lg-5" href="{{ URL::to('/') }}">
                            <img src="{{ asset('img/login/sipaling print new.png') }}" alt="" style="margin-left:50px;width:180px; height:100px;">
                            {{-- <i class="fa fa-shopping-bag fa-3x"></i> <span class="logo">Si Paling Print</span> --}}
                            {{-- <img src="{{ asset('img/login/sipaling print new.png') }}" alt=""></i> <span class="logo text-main">Si Paling Print</span> --}}
                        </a>
                    </div>
